...
import { addNewProduct, getAllProducts, editProduct, deleteProduct, getProductById } from "../controllers/prodcutController.js";
import upload from "../middlerware/imageupload.js";

const productRoutes = express.Router();

// Product routes
productRoutes.post("/addNewProduct", upload.fields([{ name: 'productimage' }]), addNewProduct);
